...
// Regular Expression
  ...
  static String validatePasswordPattern = r'/^(?=.[A-Z])(?=.[a-z])(?=.\d)(?=.[!@#$%^&(),.?":{}|<>])[A-Za-z\d!@#$%^&(),.?":{}|<>]{8,}$/';
}
...
List<String> listStatus = ["confirmed", "processing", "shipped", "delivered"];
// class OrderStatusNo {
...
class OrderStatusNo {
  ...
  static const String kBID = "bid";
  static const String kRUNNING = "running";
  static const String kCONFIRMED = "confirmed";
...
const String kKeyPhoneNo = 'phone_no';
const String kKeySiteLogo = 'site_logo';
const String kKeyStatus = 'status';
const String kKeySettings = 'settings';
const String kKeyIsManufacturer = 'is_manufacture';
const String kKeyManufacturerStatus = 'manufacture_status';
const String kKeyIsSpinningMill = 'is_spinning_mill';
...
const String kIsPhone = 'is_phone';
...
const String kKeyCurrencySymbol = 'currency_symbol';
const String kKeyLocalCurrency = 'local_currency';
const String kKeyLocalCurrencySymbol = 'local_currency_symbol';
...
const String kKeyAvatar = 'profile_avatar';
...
const String kkeyChatID = 'chatID';
...
const String kKeyUserName = 'user-name';
const String kKeyAuthUser = 'auth-user';
const String kKeyIsSubscribe = 'is-subscribe';
const String kKeySellerType = 'seller-type';
const String kKeyDefaultProfile = "https://i.sstatic.net/l60Hf.png";
const String kKeyDefaultCover =
    "https://static.vecteezy.com/system/resources/previews/004/141/669/non_2x/no-photo-or-blank-image-icon-loading-images-or-missing-image-mark-image-not-available-or-image-coming-soon-sign-simple-nature-silhouette-in-frame-isolated-illustration-vector.jpg";
const String kkeySubscriptionType = "subscriptionType";
const String kkeyIsProfileComplete = "profile_complete";
const String kKRecaptchaToken = "6LcIjO8qAAAAAGZjnO4fX4idy684KciPvBRVrmAk";
//order statuses
